...
algorithm.results<-melt(kirby5, id.vars=c("id"), measure.vars=c("SmlK", "MedK", "LrgK"), variable.name="reward", value.name="parameter.algorithm")

algorithm.results<-arrange(algorithm.results,id)


write.table(algorithm.results, file="/Users/bryanxwu/Desktop/bryanxwu/Documents/Extra_Curricular/Research/Poldrack Lab/Practice/R-Practice-/Kirby/MCQ_Syntax/MCQindices.txt", row.names=FALSE)
```
Success
